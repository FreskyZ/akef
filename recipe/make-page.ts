...
// TODO a really good factory simulator with good item and machine icons https://github.com/hsyhhssyy/IndustrialPlanner/tree/v2
// a very good recipe viewer that they managed to *UNDERSTAND SKLAND WIKI* https://github.com/AndreaFrederica/jei-web/blob/master/scripts/generate-aef-pack.mjs
// this is a normal up to date tool but not helpful to tell me where they get data https://github.com/endfield-calc/factoriolab/blob/ark-endfield-3rd-test/src/data/aef/data.json
